...
public class Exercise37_printLevel
{
    public class BST<Key extends Comparable<Key>, Value>
    {
        ...
        public void printLevel(Node x)
        {
            ...
            while (!queue.isEmpty())
            {
                Queue<Node> queueTemp = new Queue<>();
                while (!queue.isEmpty())
                {
                    Node t = queue.dequeue();
                    StdOut.print(t.key + " " + t.value + "   ");
                    if (t.left != null) queueTemp.enqueue(t.left);
                    if (t.right != null) queueTemp.enqueue(t.right);
                }
                StdOut.println();
                queue = queueTemp;
            }
    ...
    {
        BST<String, Integer> st = new Exercise37_printLevel().new BST<>();
        int i = 0;
        while (!StdIn.isEmpty())
        {
